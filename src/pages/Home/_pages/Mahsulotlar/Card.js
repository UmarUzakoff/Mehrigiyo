...
import ROHATYogi from "../../images/ROHATYogi.svg";
    ...
    <>
      <div className="container">
        ...
        <div className="flex flex-row flex-wrap gap-0">
          <ul className="flex flex-row flex-wrap justify-center gap-7 mb-10">
            {_.map(filteredUsers, (Val, i) => (
              <li key={i} className="doriWrap">
                ...
                <div className="ml-6">
                  ...
                  <span className="itemType">{Val.type} </span>
                </div>
                <div className="flex flex-row items-center gap-16">
                  <div className="ml-6 mt-7">
                    <span className="itemSale">{Val.sale} </span>
                ...
                <Modal2 visible={createModal} setVisible={setCreateModal}>
                  <ul className="flex gap-7 containerrr">
                    {favorites.map((Val, i) => (
                      <li
                        key={i}
                        className="flex flex-row justify-between items-center gap-10 container">
                        ...
                        <div>
                          <h3 className=" font-extrabold text-2xl pt-20">
                            {Val.name}
                          </h3>
                          <img src={stars} alt="stars" />
                          <div className="flex flex-row gap-80 items-center">
                            {Val.price === 16000 ? <Price1 /> : <Price2 />}
                          </div>
                          <hr className="mt-5" />
                          <Accordion
                            open={open === 1}
